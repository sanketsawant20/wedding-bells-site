            ...
            */}
            {(sectionId === "haldi" || sectionId === "wedding-ceremony") && (
              <div 
                ...
                style={{
                  background: "radial-gradient(circle at center, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.65) 45%, rgba(255, 255, 255, 0.15) 75%, transparent 100%)"
                }} 
              />
            )}
            ...
            <div className="mx-auto max-w-xl w-full z-10">
              ...
              >
                {/* Event Icon */}
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full shadow-md bg-gradient-to-br from-gold to-gold-soft text-maroon-deep shadow-gold">
                  <Icon size={20} />
                </div>
                ...
                {/* Event Title */}
                <h3 className={`script text-5xl sm:text-6xl md:text-7xl font-bold ${
                  isDarkTheme 
                ...
                {/* Blurb */}
                <p className={`text-base sm:text-lg italic max-w-md mx-auto mt-0.5 mb-6 leading-relaxed font-serif ${
                ...
                {/* Details List */}
                <div className={`mt-6 space-y-3 text-xs sm:text-sm text-left max-w-sm mx-auto border-t pt-4 ${
                  isDarkTheme 

...
export const EnvelopeIntro: React.FC<EnvelopeIntroProps> = ({ onOpen }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-blush via-ivory to-gold-soft">
      {/* Decorative Emojis */}
      <div
        className="absolute top-8 left-8 text-6xl opacity-20 select-none animate-bounce"
        style={{ animationDuration: "4s" }}
      >
        🌸
      </div>
      <div
        className="absolute top-8 right-8 text-6xl opacity-20 select-none animate-bounce"
        style={{ animationDuration: "4.5s" }}
      >
        ✨
      </div>
      <div
        className="absolute bottom-8 left-8 text-6xl opacity-20 select-none animate-bounce"
        style={{ animationDuration: "5s" }}
      >
        ✨
      </div>
      <div
        className="absolute bottom-8 right-8 text-6xl opacity-20 select-none animate-bounce"
